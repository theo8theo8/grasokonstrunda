      ...
      <div className={styles.box}>
        <div style={{ flexDirection: "row", display: "flex" }}>
          ...
          <div className={styles.boxheader}>
            ...
            <p>
              <em>
                Är ni sugna på att besöka några mysiga caféer eller lunchställen
                kan vi tipsa om dessa.
              </em>
            </p>
          </div>
        </div>
        ...
        <p>
          Gräsö Camping & Restaurang Doppingen <b>(8)</b> erbjuder mat, glass,
          bad m.m samt tillgång till handikapptoalett.
        </p>
        <p>
